...
public class FlappyBird extends ApplicationAdapter {
	...
	public void create () {
		...
		dragon = new Texture[12];
        dragon[0] = new Texture("dragon1.png");
		dragon[1] = new Texture("dragon2.png");
		dragon[2] = new Texture("dragon3.png");
		dragon[3] = new Texture("dragon4.png");
		dragon[4] = new Texture("dragon5.png");
		dragon[5] = new Texture("dragon6.png");
		dragon[6] = new Texture("dragon7.png");
		dragon[7] = new Texture("dragon8.png");
		dragon[8] = new Texture("dragon9.png");
		dragon[9] = new Texture("dragon10.png");
		dragon[10] = new Texture("dragon11.png");
		dragon[11] = new Texture("dragon12.png");
	...
	public void startGame(){
		...
		birdY = Gdx.graphics.getHeight()/2 - dragon[0].getHeight()/2;
	...
	public void render () {
		...
		batch.draw(dragon[dragonFlapState], Gdx.graphics.getWidth() / 2 - dragon[dragonFlapState].getWidth() / 2, birdY);

		dragonFlapState++;
		if(dragonFlapState == 12) {
			dragonFlapState = 0;
		}
		...
		birdCircle.set(Gdx.graphics.getWidth()/2 + +120 , birdY  + dragon[dragonFlapState].getHeight()/2 - 100, dragon[dragonFlapState].getWidth()/2 - 200);
